...
# You MUST provide your own SQL migration content
sqlFileContent: |
...
<configuration>
    <configFile>src/main/resources/codegen.yaml</configFile>
    <skipIfExists>true</skipIfExists>  <!-- Skip generation if files exist -->
</configuration>
```
...
<configuration>
    <configFile>src/main/resources/codegen.yaml</configFile>
    <forceRegenerate>true</forceRegenerate>  <!-- Force regenerate all files -->
</configuration>
```
...
public class UserController extends BaseUserController {
    ...
    public ResponseEntity<List<User>> getActiveUsers() {
        return ResponseEntity.ok(customUserService.findActiveUsers());
    }
...
For detailed examples, see [EXTENSIBLE_EXAMPLES.md](EXTENSIBLE_EXAMPLES.md).
...
- Use `@Primary` annotation to override generated controllers
